...
public class PublicAppRunnerService<T extends PublicAppRunnerServiceProps> extends
    AbstractAppRunnerService<T> {

  public PublicAppRunnerService(@NotNull final Construct scope,
    ...
    this.service = Service.Builder.create(scope, "%sAppRunnerService".formatted(serviceId))
        .source(ecrSource)
  ...
  @Getter
  @SuperBuilder
  public static class PublicAppRunnerServiceProps extends AppRunnerServiceProps {

    private final SubnetType subnetType = SubnetType.PUBLIC;
  }
}