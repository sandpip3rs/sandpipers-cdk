...
public class PrivateIsolatedAppRunnerService<T extends PrivateIsolatedAppRunnerService.PrivateIsolatedAppRunnerServiceProps> extends
    AbstractAppRunnerService<T> {

  public PrivateIsolatedAppRunnerService(@NotNull final Construct scope,
  ...
  @Getter
  @SuperBuilder
  public static class PrivateIsolatedAppRunnerServiceProps extends AppRunnerServiceProps {
