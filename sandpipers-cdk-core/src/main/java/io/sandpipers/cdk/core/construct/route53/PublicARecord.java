 ...
 */
public class PublicARecord<T extends PublicARecordProps> extends AbstractARecord<T> {

  public PublicARecord(@NotNull final Construct scope,
  ...
  @Getter
  @SuperBuilder
  public static class PublicARecordProps extends ARecordProps {

    private final Boolean privateZone = false;

    @Default
    @NotNull
    private final String domainName = "services.sandpipers.com";
  }
}
