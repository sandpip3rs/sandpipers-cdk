...
public class Application extends AbstractApp {
  ...
  public static void main(String[] args) {
    ...
    tagStackResources(queueStack, SANDPIPERS_TEST_111111111111_AP_SOUTHEAST_2, CostCentre.SANDPIPERS, APPLICATION_NAME);

    final QueueStack fifoQueueStack = new QueueStack(app, SANDPIPERS_TEST_111111111111_AP_SOUTHEAST_2);
    tagStackResources(fifoQueueStack, SANDPIPERS_TEST_111111111111_AP_SOUTHEAST_2, CostCentre.SANDPIPERS, APPLICATION_NAME);
