...
public class QueueTest extends TemplateSupport {
  ...
  static void initAll() {
    ...
    tagStackResources(queueStack, SANDPIPERS_TEST_111111111111_AP_SOUTHEAST_2, CostCentre.SANDPIPERS, app.getApplicationName());
