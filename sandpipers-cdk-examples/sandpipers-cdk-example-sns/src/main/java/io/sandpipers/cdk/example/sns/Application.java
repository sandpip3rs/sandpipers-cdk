...
public class Application extends AbstractApp {
  ...
  public static void main(String[] args) {
    ...
    tagStackResources(topicStack, SANDPIPERS_TEST_111111111111_AP_SOUTHEAST_2, APPLICATION_NAME);

    final FifoTopicStack fifoTopicStack = new FifoTopicStack(app, SANDPIPERS_TEST_111111111111_AP_SOUTHEAST_2);
    tagStackResources(fifoTopicStack, SANDPIPERS_TEST_111111111111_AP_SOUTHEAST_2, APPLICATION_NAME);
