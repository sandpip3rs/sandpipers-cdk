...
public class Application extends AbstractApp {
  ...
  private static final SafeString APPLICATION_NAME = SafeString.of("sns-cdk-example");

  public static void main(String[] args) {
    final Application app = new Application();

    final TopicStack topicStack = new TopicStack(app, SANDPIPERS_TEST_111111111111_AP_SOUTHEAST_2);
    tagStackResources(topicStack, SANDPIPERS_TEST_111111111111_AP_SOUTHEAST_2, CostCentre.SANDPIPERS, APPLICATION_NAME);

    final FifoTopicStack fifoTopicStack = new FifoTopicStack(app, SANDPIPERS_TEST_111111111111_AP_SOUTHEAST_2);
    tagStackResources(fifoTopicStack, SANDPIPERS_TEST_111111111111_AP_SOUTHEAST_2, CostCentre.SANDPIPERS, APPLICATION_NAME);
