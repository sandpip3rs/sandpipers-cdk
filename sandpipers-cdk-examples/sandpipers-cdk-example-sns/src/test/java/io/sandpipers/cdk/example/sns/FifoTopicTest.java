...
public class FifoTopicTest extends TemplateSupport {
  ...
  static void initAll() {
    ...
    tagStackResources(fifoTopicStack, SANDPIPERS_TEST_111111111111_AP_SOUTHEAST_2, app.getApplicationName());
  ...
  void should_have_topic() {
    ...
    assertThat(template)
        ...
        .hasTopicName("^SandpipersSnsCdkExampleStake-Topic-[a-zA-Z0-9]{8}.fifo$")
        .isFifo(true)
        .hasContentBasedDeduplicationEnabled(true)
        .hasMessageRetentionPeriodInDays(30)
