...
public class Application extends AbstractApp {
  ...
  private static final SafeString APPLICATION_NAME = SafeString.of("route53-cdk-example");

  public static void main(String[] args) {
    final Application app = new Application();

    final Route53Stack route53Stack = new Route53Stack(app, SANDPIPERS_TEST_111111111111_AP_SOUTHEAST_2);
    tagStackResources(route53Stack, SANDPIPERS_TEST_111111111111_AP_SOUTHEAST_2, CostCentre.SANDPIPERS, APPLICATION_NAME);
