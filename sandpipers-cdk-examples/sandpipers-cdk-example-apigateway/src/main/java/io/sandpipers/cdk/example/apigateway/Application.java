...
public class Application extends AbstractApp {
  ...
  public static void main(String[] args) {
    ...
    tagStackResources(lambdaStack, SANDPIPERS_TEST_111111111111_AP_SOUTHEAST_2, APPLICATION_NAME);

    final RestApiStack restApiStack = new RestApiStack(app, SANDPIPERS_TEST_111111111111_AP_SOUTHEAST_2);
    tagStackResources(restApiStack, SANDPIPERS_TEST_111111111111_AP_SOUTHEAST_2, APPLICATION_NAME);
