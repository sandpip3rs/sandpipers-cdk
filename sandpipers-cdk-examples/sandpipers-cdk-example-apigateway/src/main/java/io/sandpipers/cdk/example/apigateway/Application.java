...
public class Application extends AbstractApp {
  ...
  private static final SafeString APPLICATION_NAME = SafeString.of("apigateway-cdk-example");

  public static void main(String[] args) {
    final Application app = new Application();

    final LambdaRestApiStack lambdaStack = new LambdaRestApiStack(app, SANDPIPERS_TEST_111111111111_AP_SOUTHEAST_2);
    tagStackResources(lambdaStack, SANDPIPERS_TEST_111111111111_AP_SOUTHEAST_2, CostCentre.SANDPIPERS, APPLICATION_NAME);

    final RestApiStack restApiStack = new RestApiStack(app, SANDPIPERS_TEST_111111111111_AP_SOUTHEAST_2);
    tagStackResources(restApiStack, SANDPIPERS_TEST_111111111111_AP_SOUTHEAST_2, CostCentre.SANDPIPERS, APPLICATION_NAME);
