...
public class PrivateIsolatedAppRunnerSandpiperServiceStackTest extends TemplateSupport {
  ...
  static void initAll() {
    ...
    tagStackResources(privateIsolatedAppRunnerServiceStack, SANDPIPERS_TEST_111111111111_AP_SOUTHEAST_2, CostCentre.SANDPIPERS,
