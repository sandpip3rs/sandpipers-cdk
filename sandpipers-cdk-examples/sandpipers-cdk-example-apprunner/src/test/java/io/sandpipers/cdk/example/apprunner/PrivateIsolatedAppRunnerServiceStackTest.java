...
public class PrivateIsolatedAppRunnerServiceStackTest extends TemplateSupport {

  @BeforeAll
  static void initAll() {
    final Application app = new Application();

    final PrivateIsolatedAppRunnerServiceStack privateIsolatedAppRunnerServiceStack =
        new PrivateIsolatedAppRunnerServiceStack(app, SANDPIPERS_TEST_111111111111_AP_SOUTHEAST_2);

    tagStackResources(privateIsolatedAppRunnerServiceStack, SANDPIPERS_TEST_111111111111_AP_SOUTHEAST_2, CostCentre.SANDPIPERS, app.getApplicationName());

    template = Template.fromStack(privateIsolatedAppRunnerServiceStack);
  }
  ...
  void should_have_app_runner_service() {
    assertThat(template)
        ...
        .hasImageIdentifier("arn:aws:ecr:ap-southeast-2:111111111111:repository/sandpipers/apprunner-cdk-example:latest")
        .runsOnPort("8080")
  ...
  void should_have_app_runner_service_service_role_default_policy() {
    final String ecrRepoResource = "arn:aws:ecr:ap-southeast-2:111111111111:repository/arn:aws:ecr:ap-southeast-2:111111111111:repository/sandpipers/apprunner-cdk-example";
  ...
  void should_have_vpc_connector_security_group() {
    assertThat(template)
        ...
        .hasDescription("Security group for VPC connector")
        .hasVpcId("^vpc-12345$")
  ...
  @Test
  void should_have_vpc_connector_security_group_ingress_rule() {
    assertThat(template)
        .containsSecurityGroupIngressRule("^VpcConnectorSecurityGroupfromSandpipersApprunnerCdkExampleStakeApiGatewaySecurityGroup[a-zA-Z0-9]{1,20}$")
        .hasDescription("Allow tcp traffic from API Gateway")
        .hasFromPort(443)
        .hasGroupId("VpcConnectorSecurityGroup[a-zA-Z0-9]{8}")
        .hasIpProtocol("tcp")
        .hasSourceSecurityGroupId("sg-1234567890abcdef")
        .hasToPort(443);
  }
}