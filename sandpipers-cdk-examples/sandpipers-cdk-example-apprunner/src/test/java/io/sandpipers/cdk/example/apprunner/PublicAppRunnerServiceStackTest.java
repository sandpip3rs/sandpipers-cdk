...
public class PublicAppRunnerServiceStackTest extends TemplateSupport {
  ...
  void should_have_app_runner_service() {
    assertThat(template)
        .containsAppRunnerService("^apprunnercdkexampleAppRunnerService([a-zA-Z0-9]{8})?$")
        ...
        .hasImageIdentifier(
            "arn:aws:ecr:ap-southeast-2:111111111111:repository/sandpipers/apprunner-cdk-example:latest")
        .runsOnPort("8080")
...
//        .hasPolicyDocumentStatement("Allow", "2012-10-17", List.of("*"), List.of("ecr:BatchCheckLayerAvailability", "ecr:GetDownloadUrlForLayer", "ecr:BatchGetImage")); // TODO finish me;
  }
}
