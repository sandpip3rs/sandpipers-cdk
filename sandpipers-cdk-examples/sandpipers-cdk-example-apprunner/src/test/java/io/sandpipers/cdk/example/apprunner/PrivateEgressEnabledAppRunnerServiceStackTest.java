...
public class PrivateEgressEnabledAppRunnerServiceStackTest extends TemplateSupport {
  ...
  static void initAll() {
    ...
    tagStackResources(PrivateEgressEnabledAppRunnerServiceStack, SANDPIPERS_TEST_111111111111_AP_SOUTHEAST_2, app.getApplicationName());
