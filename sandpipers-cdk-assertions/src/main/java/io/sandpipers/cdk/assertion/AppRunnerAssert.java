...
public class AppRunnerAssert extends
  ...
  public AppRunnerAssert hasNetworkConfiguration(final String expectedEgressType,
      final Boolean expectedIsPubliclyAccessible,
      final String expectedVpcConnectorArnReference) {
    final Map<String, Object> properties = (Map<String, Object>) actual.get("Properties");
    final Map<String, Object> networkConfiguration = (Map<String, Object>) properties.get(
        "NetworkConfiguration");
    ...
    final Map<String, List<String>> vpcConnectorArn =
        (Map<String, List<String>>) egressConfiguration.get("VpcConnectorArn");
    ...
    Assertions.assertThat(vpcConnectorArnFun)
        ...
        .anySatisfy(s -> Assertions.assertThat(s)
            .isInstanceOf(String.class)
            .matches(e -> e.matches(expectedVpcConnectorArnReference)));

    final Map<String, Boolean> ingressConfiguration = (Map<String, Boolean>) networkConfiguration.get(
        "IngressConfiguration");
    final Boolean actualIsPubliclyAccessible = ingressConfiguration.get("IsPubliclyAccessible");
    Assertions.assertThat(actualIsPubliclyAccessible).
        isEqualTo(expectedIsPubliclyAccessible);
