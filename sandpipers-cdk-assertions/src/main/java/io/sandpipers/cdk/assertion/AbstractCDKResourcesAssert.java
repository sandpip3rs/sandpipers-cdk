...
//                        .isEqualTo(isNotEmpty(resources) && resources.size() == 1 ? resources.get(0) : resources);
...
//                          .extracting("Ref")
//                          .asString()
//                          .matches(ref -> ref.matches(resources.get(0)));
//                    } else if (resMap.containsKey("Fn::Join")) {
//                      final String resourceArn = flattenSourceArn(resMap);
//                      Assertions.assertThat(resourceArn)
