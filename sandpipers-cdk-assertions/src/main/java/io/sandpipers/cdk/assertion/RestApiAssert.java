...
/**
 * Fluent assertions for <code>AWS::ApiGateway::RestApi</code>. This should be used if the resource map is extracted from the AWS template. Otherwise, start with
