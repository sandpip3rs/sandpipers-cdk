...
/**
 * Fluent assertions for <code>AWS::Lambda::EventInvokeConfig</code>. This should be used if the resource map is extracted from the AWS template. Otherwise, start
 * with {@link CDKStackAssert#containsLambdaEventInvokeConfig(String)}.
 */
...
public class LambdaEventInvokeConfigAssert extends
  ...
  public LambdaEventInvokeConfigAssert hasLambdaEventInvokeConfig(final String expectedFunctionName,
    ...
    final String actualFunctionName = ((Map<String, String>) properties.get("FunctionName")).get("Ref");

    Assertions.assertThat(actualFunctionName)
        .isInstanceOf(String.class)
        .matches(actual -> actual.matches(expectedFunctionName));

    final Map<String, Object> destinationConfig = (Map<String, Object>) properties.get("DestinationConfig");
  ...
  public LambdaEventInvokeConfigAssert hasMaximumRetryAttempts(final Integer expected) {
    final Map<String, Object> properties = (Map<String, Object>) actual.get("Properties");
  ...
  public LambdaEventInvokeConfigAssert hasMaximumEventAgeInSeconds(final Integer expected) {
    final Map<String, Object> properties = (Map<String, Object>) actual.get("Properties");
    Assertions.assertThat((Integer) properties.get("MaximumEventAgeInSeconds"))
        .isInstanceOf(Integer.class)
        .isEqualTo(expected);
  ...
  public LambdaEventInvokeConfigAssert hasQualifier(final String expected) {
    final Map<String, Object> properties = (Map<String, Object>) actual.get("Properties");
  ...
  public LambdaEventInvokeConfigAssert hasFunctionName(final String expected) {
    final Map<String, Object> properties = (Map<String, Object>) actual.get("Properties");
    final Map<String, String> functionName = (Map<String, String>) properties.get("FunctionName");
    final String functionReference = functionName.get("Ref");

    Assertions.assertThat(functionReference)
        .matches(actual -> actual.matches(expected));
