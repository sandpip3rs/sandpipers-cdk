 ...
 */
public class SafeString extends StringType implements CharSequence {
  ...
  @JsonCreator
  public static SafeString of(final CharSequence value) {
    return TYPE_PARSER.parseToStringType(value, SafeString::new);
  }
  ...
  private SafeString(final String value) {
    super(value);
  }
}
