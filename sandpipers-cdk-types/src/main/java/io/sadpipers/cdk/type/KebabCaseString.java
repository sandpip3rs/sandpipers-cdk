 ...
 */
public class KebabCaseString extends StringType implements CharSequence {

  private static final int MIN_SIZE = 1;
  private static final int MAX_SIZE = 500;
  private static final String SPECIAL_CHARS = "-";
  private static final MessageCode ERROR_MESSAGE = MessageCode.of(
      "invalid.string.kebab.case",
  ...
  @JsonCreator
  public static KebabCaseString of(final CharSequence value) {
    return TYPE_PARSER.parseToStringType(value, KebabCaseString::new);
  }
  ...
  private KebabCaseString(final String value) {
    super(value);
  }
}
