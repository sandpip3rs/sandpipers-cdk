 ...
 */
public class Path extends StringType implements CharSequence {
  ...
  @JsonCreator
  public static Path of(final CharSequence value) {
    return TYPE_PARSER.parseToStringType(value, Path::new);
  }
